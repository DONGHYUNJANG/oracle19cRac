...
| VM 이름 | 호스트 이름 | 메모리 | 어댑터1(public) | 어댑터2(private) | 구성 방법 |
| --- | --- | --- | --- | --- | --- |
...
![2026-04-06 162244](https://github.com/user-attachments/assets/cfee9b3a-e9b9-48ab-968d-772b992057a6)


NAT 네트워크를 선택하고 만들기를 누룹니다.
![2026-04-06 162435](https://github.com/user-attachments/assets/44f289d6-57a5-4177-bee8-9787254772d0)

![2026-04-06 162705](https://github.com/user-attachments/assets/93156215-8315-4c2e-a262-17d80b27976f)
...
**`rac1`의 어댑터 1**과 **`rac2`의 어댑터 1**이 **서로 같은 이름을 선택**해야만 합니다.

- `rac1`에서 `NatNetwork`를 선택했다면, `rac2`에서도 `NatNetwork`를 선택해야 합니다.
- `rac1`에서 `NatNetwork1`을 선택했다면, `rac2`에서도 `NatNetwork1`을 선택해야 합니다.

<img width="743" height="500" alt="image" src="https://github.com/user-attachments/assets/3c3a0fc8-94f5-49da-9c00-36f6b71fa657" />
